const table_rows={
    ...
    date:{val:-1,descr:"hidden anyway",color: "#fff",checked:"checked",yscale: "y20",hidden:true,},//hiden from table but alwais fetched
    consum_rate:{val:-1,descr:"Рейт потребления ,с",color: "#456",checked:"unchecked",yscale: "y1",calculated:true,},
}
